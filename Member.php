...
if (isset($_SESSION["UT"])) {
    ...
    $userFname = $_SESSION["UF"];
			...
			echo "alert('คุณไม่สามารถเข้าใช้งานได้');";
...
<body>
    ...
    <div class="container mt-4" >
        ...
        <div class="col text-center mt-4">
            <div><h1>Member Management</h1></div>
        </div>
        </div>
        <div class="row">
        ...
        <a class="btn" style=" background-color:  #728bb1; color:#ffffff;"href="Member.php?&work=A" role="button">New data</a>
	    <a class="btn "style=" background-color:  #C4D7E0; color:#ffffff;" href="Member.php" role="button">Refresh</a>
	
        </div>
 		<?php $Cust_Data = $db_handle->Textquery("SELECT * FROM MEMBER ");
 		if (!empty($Cust_Data)) { ?>
				...
				<tr>
					<td><?php echo$Cust_Data[$key]["Cust_id"]; ?></td>
					<td><?php echo$Cust_Data[$key]["Cust_firstname"]; ?></td>
					<td><?php echo$Cust_Data[$key]["Cust_lastname"]; ?></td>
					<td>
                    <a href="Member.php?Cid=<?php echo$Cust_Data[$key]["Cust_id"]; ?>&work=V"   class="button1" role = "button1" >แสดง</button>
                    <a href="MemberProcess.php?Cid=<?php echo$Cust_Data[$key]["Cust_id"]; ?>&work=D"  class="button2" 
		...
		<?php } ?>
           ...
           <?php 
                $custdetail = $db_handle->Textquery("SELECT * FROM MEMBER WHERE Cust_id = '".$Ccode."' ");
            ?>
            ...
            <div class="col-5 p-0"   >
            <form action="MemberProcess.php?work=<? echo $work; ?>" method="POST" enctype="multipart/form-data">
...
<div class="border p-1 text-center text-white bg-success" style= "margin-top: 1px; text-align: center ; border-radius:2rem;  font-size: 18px;">Member Description : </div>
                    ...
                    <div class ="row ">
                        <div class="col-5" >
                         <label class=" m-0 pl-3 text-right" stlye = "font-size: 7px;"> MemberID :</label>
                        </div>
                        <div class="col-7"  >
                      
                            <input class="form-control input-sm" id="inputsm" type="text"  name ="Cid" <?php if ($work <> 'A') {echo 'readonly';} ?> value = "<?php if ($work <> 'A') { echo $custdetail[0]["Cust_id"]; } ?>" >
                        </div>
                    </div>
                    ...
                    <div class ="row ">
                        ...
                        <div class="col-7">
                            ...
                            <input class="form-control input-sm" id="inputsm" type="text" name ="Cun" value = "<?php if ($work <> 'A') { echo $custdetail[0]["Cust_UN"]; } ?>">
                        </div>
                    </div>
                    ...
                    <div class ="row ">
                        <div class="col-5">
                            <label class=" m-0 pl-3 text-right"> Lavel :</label>
                        </div>
                        <div class="col-7">
                            <input class="form-control input-sm" id="inputsm" type="text" name ="Cvel" value = "<?php if ($work <> 'A') { echo  $custdetail[0]["Cust_level"]; } ?>" >
                        </div>
                    </div>

                    <div class ="row ">
                        <div class="col-5">
                            <label class=" m-0 pl-3 text-right"> Birth :</label>
                        </div>
                        <div class="col-7">
                    ...
                    <div class ="row ">
                        <div class="col-5">
                            <label class=" m-0 pl-3 text-right"> Address:</label>
                        </div>
                        <div class="col-7">
                            <input class="form-control input-sm" id="inputsm" type="text" name ="Cadd" value = "<?php if ($work <> 'A') { echo $custdetail[0]["Cust_address"]; } ?>" >
                        </div>
                    </div>

                    <div class ="row ">
                        <div class="col-5">
                            <label class=" m-0 pl-3 text-right"> Tel :</label>
                        </div>
                        <div class="col-7">
                    ...
                    <div class ="row " >
                        <div class="col" >
                            <img src="<?php if ($work <> 'A'){echo  $custdetail[0]["Cust_picture"];} else{echo 'img/2.png';}  ?>"  style="margin-left:15px; width: 100px; border-radius:1rem;height: 100px;">
                        </div>
